  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Hier kannst du mir direkt eine Nachricht schreiben." />
      </Helmet>
      <section className="max-w-2xl mx-auto py-16 px-6 text-center bg-white dark:bg-slate-900 rounded-3xl shadow-lg">
        <h2 className="text-3xl font-bold mb-4 text-slate-900 dark:text-white">Kontakt</h2>
        <p className="mb-6 text-lg text-slate-800 dark:text-gray-300">
          Du hast Fragen, Feedback oder möchtest zusammenarbeiten?<br />
        ...
        <p className="mt-8 text-slate-800 dark:text-gray-300">
          Oder schau bei <a href="https://www.instagram.com/fitandtravelblog/" target="_blank" rel="noopener noreferrer" className="text-pink-500 font-bold underline hover:text-yellow-400 transition">Instagram</a> vorbei!
        </p>
      </section>
    </>
  );
